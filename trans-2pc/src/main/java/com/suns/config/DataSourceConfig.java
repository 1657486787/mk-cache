...
public class DataSourceConfig {
    ...
    public DataSource ghDataSource(Environment env) throws PropertyVetoException {
    ...
    public AtomikosDataSourceBean nhDataSource(Environment env) throws PropertyVetoException {
        AtomikosDataSourceBean ds = new AtomikosDataSourceBean();
